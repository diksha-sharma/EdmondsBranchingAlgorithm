...
public class Edge {
    ...
    public int OriginalWeight;// weight of the arc
    public boolean activeEdge = true; //Boolean field to know if this edge needs to be considered for MST calculation
    /**
	...
	To = v;
	Weight = w;
	OriginalWeight = w; //To keep track of original weight
    }
